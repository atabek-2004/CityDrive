...
class ClassConteynerWidget extends StatefulWidget {
  final ScheduleItemsDTO? scheduleItemsDTO;
  final int index;
  const ClassConteynerWidget({
    super.key,
    required this.scheduleItemsDTO,
    required this.index,
  });

  @override
  State<ClassConteynerWidget> createState() => _ClassConteynerWidgetState();
}

class _ClassConteynerWidgetState extends State<ClassConteynerWidget> {
          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  Text(
                    widget.scheduleItemsDTO?.items?[widget.index].activity
                            ?.title ??
                        '',
                  ...
                  Text(
                    formatTime(
                      widget.scheduleItemsDTO?.items?[widget.index].startTime,
                    ),
                  ...
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            widget.scheduleItemsDTO?.items?[widget.index]
        ...
        Positioned.fill(
          child: Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(24),
              onTap: () {
                context.router.push(ClassRoute(showSchedule: true));
              },
            ),
          ),
        ),
