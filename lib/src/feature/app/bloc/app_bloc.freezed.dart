...
mixin _$AppState {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_BannedState value) banned,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult? Function(_BannedState value)? banned,
...
/// @nodoc
abstract class _$$BannedStateImplCopyWith<$Res> {
  factory _$$BannedStateImplCopyWith(
          _$BannedStateImpl value, $Res Function(_$BannedStateImpl) then) =
      __$$BannedStateImplCopyWithImpl<$Res>;
}

/// @nodoc
class __$$BannedStateImplCopyWithImpl<$Res>
    extends _$AppStateCopyWithImpl<$Res, _$BannedStateImpl>
    implements _$$BannedStateImplCopyWith<$Res> {
  __$$BannedStateImplCopyWithImpl(
      _$BannedStateImpl _value, $Res Function(_$BannedStateImpl) _then)
      : super(_value, _then);
...
class _$BannedStateImpl with DiagnosticableTreeMixin implements _BannedState {
  const _$BannedStateImpl();

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AppState.banned()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'AppState.banned'));
  }

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$BannedStateImpl);
  }
...
abstract class _BannedState implements AppState {
  const factory _BannedState() = _$BannedStateImpl;
}
